                ...
                <ion-card class="shadow-none border-none bg-transparent">
                  ...
                  <ion-card-content class="my-12">
                    <form @submit="onSubmit" :validation-schema="schema">
                      <ion-row>
                        <ion-col class="p-3">
                          <ion-input class="w-100" clear-input type="text" placeholder="Name" v-model="name">
                            <slot name="start">
                      ...
                      <ion-button color="primary" class="mt-12" expand="block" type="submit">Register</ion-button>
                    </form>
                    <div class="flex justify-center mt-5">
                      <p class="text-sm">Sudah punya akun? <a href="login">Login</a></p>
                    </div>
                  </ion-card-content>
                </ion-card>
              </ion-col>
